...
народный:
		...
		коли(письмена.добрый_молодец()) {
			коли(письмена.добрый_молодец()) {
				...
				покуда(письмена >> вершина_1 >> вершина_2 >> длина_тропы) {
					матрёшка[вершина_1][вершина_2] = длина_тропы;
				}
				письмена.закупорить();
			}
	...
	Путеводный_камень(много_букав название_летописи, розсуд связь_обоюдная): связь_обоюдная(связь_обоюдная){
		...
		коли(письмена.добрый_молодец()) {
			коли(письмена.добрый_молодец()) {
				...
				покуда(письмена >> вершина_1 >> вершина_2 >> длина_тропы) {
					...
					коли(связь_обоюдная)
						матрёшка[вершина_2][вершина_1] = длина_тропы;
				}
				письмена.закупорить();
			}
	...
	Путеводный_камень(целина число_вершин, целина начало, целина край, розсуд связь_обоюдная) : число_вершин(число_вершин), начало(начало), край(край), связь_обоюдная(связь_обоюдная) {
	...
	Тропа наказ_Дейкстра() {
		...
		покуда(край != цель_конец) {
			...
			для(целина дж = 0; дж < число_вершин; ++дж) {
				...
				целина длина = матрёшка[старт][дж];
